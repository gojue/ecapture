...
// bssl::SSL3_STATE->server_traffic_secret_0 (TLS 1.3, persists after hs freed)
#define BSSL__SSL3_STATE_SERVER_TRAFFIC_SECRET_0 0x120

// bssl::SSL3_STATE->client_traffic_secret_0 (TLS 1.3, persists after hs freed)
...
// bssl::SSL3_STATE traffic secret lengths (1 byte each)
