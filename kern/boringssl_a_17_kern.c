#ifndef ECAPTURE_BORINGSSL_A_17_KERN_H
#define ECAPTURE_BORINGSSL_A_17_KERN_H
...
#define BSSL__SSL_HANDSHAKE_EARLY_SESSION 0x7d8

// bssl::SSL_HANDSHAKE->hints
#define BSSL__SSL_HANDSHAKE_HINTS 0x808

// bssl::SSL_HANDSHAKE->client_version
#define BSSL__SSL_HANDSHAKE_CLIENT_VERSION 0x814
